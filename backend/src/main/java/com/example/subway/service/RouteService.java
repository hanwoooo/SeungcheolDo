...
public class RouteService {
    ...
    // 경유지가 있을 경우 경로 탐색
    public RouteResultDto findRouteWithWaypoints(String departureStationName, String arrivalStationName, List<String> waypoints, String option) {
        ...
        RouteResultDto routeResultDto = new RouteResultDto(new ArrayList<>(), new RouteResultDto.TotalValueResult());
        RouteResultDto newResult;
        ...
        for (String stopStationName : waypoints) {
            ...
            mergeResultsWithTransfer(routeResultDto, newResult);
    ...
    // 경유지가 없을 경우 경로 탐색
    public RouteResultDto findRoute(String departureStationName, String arrivalStationName, String option) {
        option = setOption(option);
    ...
    private void mergeResultsWithTransfer(RouteResultDto totalResult, RouteResultDto newResult) {
        ...
        RouteResultDto.TotalValueResult totalValues = totalResult.getValueResults();
        RouteResultDto.TotalValueResult tempValues = newResult.getValueResults();
