...
//   const [currentCoordinates, setCurrentCoordinates] = useState<{ x: number; y: number }[]>([]); // 선택된 경로 좌표 state -- 서버에서 받으면 변경 
...
//           const filteredAngle = isNaN(kalman.update(angleZ)) ? 0 : kalman.update(angleZ);
...
//         <Image source={require('./assets/109.png')} style={[styles.map]} />
