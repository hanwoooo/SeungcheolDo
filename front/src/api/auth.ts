import { CoordsData, DijkstraResult, InsideStationCoordinates, InsideStationImageURL, InsideStationPath, RequestUser, ResponseProfile, Route, StationData, StationInformation, Stationlist } from "@/types/domain";
...
export const postInsideStationURL = async ({ line, stationName, isTransfer }: InsideStationPath): Promise<InsideStationImageURL> => {
...
export const postCoordsData = async ({ line, stationName, exitNum, stationType }: InsideStationCoordinates): Promise<CoordsData> => {
